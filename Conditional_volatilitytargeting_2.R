...
# In dit script wordt er geen gebruik gemaakt van de Return.portfolio functie() (zoals in Conditional_volatilitytargeting_1.R), hierdoor is het uitvoeren van het script aanzienlijk trager. 
# De bedoeling van dit script is om de lezer een beter begrip te geven van de praktische werking van de conditionele volatiliteitstargetingstrategie. 
...
# Vergeet niet om volgende zaken aan te passen: de gewenste portefeuillegewichten (als decimaal), de plaats om de resultaten op te slaan, de blootstellingslimiet, de volatiliteitslimieten (zie lijn 158 en 159).
