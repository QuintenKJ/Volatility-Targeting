# Inladen pakketten
  ...
  library(xts)
  library(writexl)
  load("Sharpe.RData") # Afkomstig van https://www.econ.uzh.ch/en/people/faculty/wolf/publications.html#Programming_Code , moet opgeslagen zijn in working directory (wordt gebruikt voor inferentie op Sharpe ratio)
