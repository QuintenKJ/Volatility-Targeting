# Dit script vormt Datastream datasets (indexen) om in rendementen. Deze rendementen kunnen vervolgens gebruikt worden voor het uitvoeren van backtests.
# Dit script berekent ook verschillende beschrijvende statistieken. 
# Voor het uitvoeren van dit script is het belangrijk dat de working directory gelijk wordt gesteld aan de map waarin de Excel bestanden van Datastream aanwezig zijn.
# Het is ook belangrijk dat de namen van de Excel bestanden overeenstemmen met de namen die in dit script gebruikt zijn. 
# Om de rendementen later te gebruiken, is het belangrijk om ze op te slaan als een RDS bestand. 
